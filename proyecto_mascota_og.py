...
resp = input("Escriba 'PLAY' para iniciar el programa... \n")
while  resp != "no":
    ...
    def puntos_persona(nombre, puntos):    
        print( "\n"f"{nombre}, tu puntuacion fue de {puntos} puntos, y estos fueron tus resultados de cada pregunta:")


    #Introduccion al programa
    print("Es muy importante encontrar un buen hogar para un perrito, veamos si eres apto para tener uno\n")
    ...
    while q1  > 5 : 
        ...
        print("¡Has escrito un numero fuera del rango! Intenta con un numero positivo")
...
#Mensaje final (Salida)
    ...
    if puntos == 18 and puntos >= 13:
        print("\n¡Muchas felicidades, puedes adoptar a un perrito!")

    if puntos <13 and puntos >=8:
        print("\n",nombre,",puedes tener un perrito, pero te recomendamos mejorar en las areas en las que fallas")

    if puntos <8:
        print("\n",nombre,"Lo sentimos... Parece que por el momento no puedes cuidar de un perrito :(")
    ...
    #Pregunta si el usuario quiere repetir el programa 
         
    resp = input("¿Desea repetir el programa?: ('si' / 'no') \n ")
else: 
